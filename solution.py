...
def predict(data):
    ...
    data['predicted'] = data['col1'] - data['col2']
    return data
...
def main(input_dir, output_dir):
    ...
    #    print("Invalid predicted output type {type(predicted_result)}")
...
if __name__ == "__main__":
    assert len(sys.argv) >= 3, print("Invalid number of arguments: {len(sys.argv)}")
